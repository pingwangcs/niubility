 ...
 */
public class HotResultsClient implements ResultsClient {
    private final static String RESULT_URL = "http://51zhaohu.com/services/api/rest/json/?method=event.search&featured=y&offset=0";
    private ResultsListener mHotResultsListener;
...
//                                Log.d("TAG", title);
                            ...
                            mHotResultsListener.update(results);
